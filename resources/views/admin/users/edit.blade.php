...
<div class="post d-flex flex-column-fluid" id="kt_post">
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card mb-5 mb-xl-10" id="kt_modal_add_user">
            <form action="{{route('admin.users.update')}}" id="kt_modal_add_user_form" class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$user->id}}">
                <input type="hidden" name="hidden_avatar" value="{{$user->image}}">
                        ...
                        <div class="fv-row row mb-7">
                            <div class="col-lg-3">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset(Storage::url('img/user.png'))}})">
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset(Storage::url($user->image))}});"></div>
                            ...
                            <div class="col-lg-9">
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-9 fv-row">
                                        <input value="{{$user->email}}" type="email" name="email" class=" @error('email') is-invalid border-danger @enderror form-control form-control-solid mb-3 mb-lg-0" placeholder="johndoe@gmail.com" required />
                                    </div>
                                </div>
                                <div class="row mb-6">
                                    <label class="col-lg-3 col-form-label fw-bold fs-6">
                                        ...
                                        <div class="mb-10 fv-row" data-kt-password-meter="true">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-lg form-control-solid" type="password" placeholder="Leave empty if you dont want to change" name="password" autocomplete="off" />
                        ...
                        <!--end::Input group-->
                                        ...
                                        <!--begin::Input row-->
                                            ...
                                            <div class="col-lg-3 form-check form-check-custom form-check-solid px-5 my-5">
                                                <span class=" border-danger border-2 border-start-dotted ps-2">
                                                    <!--begin::Input-->
                                                    <input class="form-check-input me-3" name="role" type="radio" value="{{$role->id}}" id="kt_modal_update_role_option_{{$key}}" required @if($user->role_id == $role->id) checked @endif />
                                                    <!--end::Input-->
                                                    <!--begin::Label-->
                                ...
                                <!--end::Input group-->
													...
													<div class="col-lg-9">
														...
														<div class="row">
															...
															<div class="col-lg-6 fv-row">
																<input value="{{$user->first_name}}" type="text" name="first_name" class=" @error('first_name') is-invalid border-danger @enderror form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="First name"  />
															</div>
															<!--end::Col-->
															<!--begin::Col-->
															<div class="col-lg-6 fv-row">
																<input value="{{$user->last_name}}" type="text" name="last_name" class=" @error('last_name') is-invalid border-danger @enderror form-control form-control-lg form-control-solid" placeholder="Last name"  />
															</div>
															<!--end::Col-->
														</div>
														<!--end::Row-->
												...
												<div class="row mb-6">
													...
													<!--begin::Col-->
													<div class="col-lg-9 fv-row">
														<input value="{{$user->phone}}" type="tel" name="phone" class=" @error('phone') is-invalid border-danger @enderror form-control form-control-lg form-control-solid" placeholder="Phone number" value="{{auth()->user()->phone}}" />
													</div>
													<!--end::Col-->
												</div>
												<!--end::Input group-->
												...
												<div class="row mb-6">
													...
													<!--begin::Col-->
													<div class="col-lg-9 fv-row">
														<input value="{{$user->address}}" type="text" name="address" class=" @error('address') is-invalid border-danger @enderror form-control form-control-lg form-control-solid" placeholder="Apt#123 , NewYork , United States..." value="{{auth()->user()->address}}" />
													</div>
													<!--end::Col-->
												</div>
												<!--end::Input group-->
												...
												<div class="row mb-6">
													...
													<div class="col-lg-9 fv-row">
														<select name="state" aria-label="Select a State" data-control="select2" data-placeholder="Select a state..." class=" @error('state') is-invalid border-danger @enderror form-select form-select-solid form-select-lg fw-bold" onchange="fetchCitiesByState(this, 'city', '{{ url('/') }}');" required>
                                                            ...
                                                            <option value="{{$user->state_id}}">@if($user->state()->exists()) {{$user->state->name}} @endif</option>
														</select>
													</div>
													<!--end::Col-->
												</div>
												...
												<div class="row mb-6">
													...
													<div class="col-lg-9 fv-row">
														<select name="city" aria-label="Select a City" data-control="select2" data-placeholder="Select a city..." class=" @error('city') is-invalid border-danger @enderror form-select form-select-solid form-select-lg fw-bold"   required>
                                                            ...
                                                            <option value="{{$user->city_id}}">@if($user->city()->exists()) {{$user->city->name}} @endif</option>
														</select>
													</div>
													<!--end::Col-->
												</div>
...
<script src="{{asset('admin/assets/js/custom/apps/user-management/users/list/update.js')}}"></script>
@endpush
@section('scripts')
<!-- Custom Functions -->
<script>
