            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
               <div class="card">
                    <div class="card-body p-12">
                        <form action="{{ route('admin.expenses.create') }}" method="POST">
                            @csrf

                            <div class="d-flex flex-column align-items-start flex-xxl-row">
                                <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4">
                                    <span class="fs-2x fw-bolder text-gray-800">Add Expense</span>
                                </div>
                            </div>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-7">
                                        ...
                                        <input type="date" name="date" class="form-control form-control-solid @error('date') is-invalid border-danger @enderror" placeholder="Pickup Date..." required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6 mb-7">
                                        <label>Amount <sup class="text-danger">*</sup></label>
                                        <input type="number" name="amount" class="form-control form-control-solid @error('amount') is-invalid border-danger @enderror" placeholder="Amount..." min="0" step=".01" required>
                                    </div>
                                    <div class="form-group col-md-6 mb-7">
                                        ...
                                        <select name="truck_id" class="form-control form-select form-select-solid @error('truck_id') is-invalid border-danger @enderror" data-control="select2" data-placeholder="Select Truck/Unit" required>
                                            ...
                                            <option value="{{ $truck->id }}">{{$truck->truck_number}} ({{ ($truck->type_id == 1)? 'Truck' : 'Trailer' }})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4 mb-7">
                                        ...
                                        <select name="load_id" class="form-control form-select form-select-solid @error('load_id') is-invalid border-danger @enderror" data-control="select2" data-placeholder="Select Load" required>
                                            ...
                                            <option value="{{ $load->id }}">{{ $load->load_number }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group col-md-4 mb-7">
                                        <label>Gallons</label>
                                        <input type="number" name="gallons" class="form-control form-control-solid @error('gallons') is-invalid border-danger @enderror" placeholder="Gallons..." min="0">
                                    </div>
                                    <div class="form-group col-md-4 mb-7">
                                        <label>Odometer</label>
                                        <input type="number" name="odometer" class="form-control form-control-solid @error('odometer') is-invalid border-danger @enderror" placeholder="Odometer Reading..." min="0">
                                    </div>
                                </div>
                                <div class="row">
