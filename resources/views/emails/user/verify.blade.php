			...
			<tr>
				<td align="center" valign="center" style="text-align:center; padding: 40px">
					<a href="{{route('home')}}" rel="noopener" target="_blank">
                        <img alt="{{siteSetting('title')}}" src="{{asset(Storage::url(siteSetting('logo_white')))}}" class="h-45px" />
					</a>
				</td>
			</tr>
			<tr>
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px; font-size: 17px;">
							<strong>Welcome to {{siteSetting('title')}}!</strong>
						</div>
						...
						<div style="padding-bottom: 30px">This password reset link will expire in {{$expiry}} minutes. If you did not request a password reset, no further action is required.</div>
						...
						<br>The {{siteSetting('title')}} Team.
						<tr>
							<td align="center" valign="center" style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
								<p>{{siteSetting('address')}}</p>
								<p>Copyright ©
								<a href="{{route('home')}}" rel="noopener" target="_blank">{{siteSetting('title')}}</a>.</p>
							</td>
						</tr></br></div>
					</div>
				</td>
