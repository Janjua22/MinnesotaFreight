...
/*!**************************************************************************************************!*\
  !*** ../../../themes/metronic/html/demo8/src/js/custom/apps/user-management/modules/list.js ***!
  \**************************************************************************************************/


// Class definition
var KTUsersModulesList = function () {
    // Shared variables
    var datatable;
    var table;
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get module name
                const moduleName = parent.querySelectorAll('td')[0].innerText;

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "Are you sure you want to delete " + moduleName + "?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        Swal.fire({
                            text: "You have deleted " + moduleName + "!.",
                            icon: "success",
                            buttonsStyling: false,
